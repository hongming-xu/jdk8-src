...
public class HashMap<K,V> extends java.util.AbstractMap<K,V>
    implements java.util.Map<K,V>, java.lang.Cloneable, Serializable {
    ...
    static java.lang.Class<?> comparableClassFor(Object x) {
        if (x instanceof java.lang.Comparable) {
            java.lang.Class<?> c; Type[] ts, as; Type t; ParameterizedType p;
     ...
     * class), else 0.
     */
    @java.lang.SuppressWarnings({"rawtypes","unchecked"}) // for cast to Comparable
    ...
    public HashMap(int initialCapacity, float loadFactor) {
        if (initialCapacity < 0)
            throw new java.lang.IllegalArgumentException("Illegal initial capacity: " +
                                               initialCapacity);
        if (initialCapacity > MAXIMUM_CAPACITY)
            initialCapacity = MAXIMUM_CAPACITY;
        if (loadFactor <= 0 || java.lang.Float.isNaN(loadFactor))
            throw new java.lang.IllegalArgumentException("Illegal load factor: " +
                                               loadFactor);
    ...
    final V putVal(int hash, K key, V value, boolean onlyIfAbsent,
        ...
        //TODO table[i]已存在 (此时p为树的root节点或链表的head节点)
        else {
            Node<K,V> e; K k;
            //TODO    key值刚好为root节点或head节点的key值
            if (p.hash == hash && ((k = p.key) == key || (key != null && key.equals(k))))
                e = p;
            //TODO 树末尾增加节点
            else if (p instanceof TreeNode)
                e = ((TreeNode<K,V>)p).putTreeVal(this, tab, hash, key, value);
            //TODO 链表末尾增加节点 (当前 p为链表的head节点)
            else {
                for (int binCount = 0; ; ++binCount) {
                    if ((e = p.next) == null) {
                        p.next = newNode(hash, key, value, null);
                        //TODO bigCount用于标识链表节点个数
    ...
    final Node<K,V>[] resize() {
        ...
        if (newThr == 0) {
            ...
            newThr = (newCap < MAXIMUM_CAPACITY && ft < (float)MAXIMUM_CAPACITY ?
                      (int)ft : java.lang.Integer.MAX_VALUE);
        }
        threshold = newThr;
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (mappings < 0)
            ...
            SharedSecrets.getJavaOISAccess().checkArray(s, java.util.Map.Entry[].class, cap);
            @java.lang.SuppressWarnings({"rawtypes","unchecked"})
    ...
    static final class TreeNode<K,V> extends java.util.LinkedHashMap.Entry<K,V> {
        ...
        static int tieBreakOrder(Object a, Object b) {
            ...
            if (a == null || b == null ||
                ...
                d = (java.lang.System.identityHashCode(a) <= java.lang.System.identityHashCode(b) ?
                     -1 : 1);
            return d;
        }
